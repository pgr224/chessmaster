...
class AppTheme {
  ...
  static TextTheme _buildTextTheme() {
    return TextTheme(
      displayLarge: GoogleFonts.fredoka(
        fontSize: 58, fontWeight: FontWeight.w700, color: textPrimary, letterSpacing: -0.5,
      ),
      displayMedium: GoogleFonts.fredoka(
        fontSize: 46, fontWeight: FontWeight.w600, color: textPrimary,
      ),
      displaySmall: GoogleFonts.fredoka(
        fontSize: 38, fontWeight: FontWeight.w600, color: textPrimary,
      ),
      ...
      labelLarge: GoogleFonts.fredoka(
        fontSize: 16, fontWeight: FontWeight.w600, color: textPrimary, letterSpacing: 1.0,
      ),
      labelMedium: GoogleFonts.fredoka(
        fontSize: 14, fontWeight: FontWeight.w500, color: textSecondary, letterSpacing: 0.5,
      ),
    );
  }
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      dividerTheme: const DividerThemeData(color: Color(0xFF2D3A6A), thickness: 1),
