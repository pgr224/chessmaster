...
Future<Map<String, dynamic>?> jsEngineGetBestMove(String fen, {int? movetime}) async {
  ...
  final bestMove = await NativeStockfish().getBestMove(fen, depth: depth, movetime: movetime);
