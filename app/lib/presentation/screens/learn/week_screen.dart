...
class WeekDetail {
  ...
  const WeekDetail({
    required this.week, required this.topic, required this.goal,
    required this.time, required this.conceptTitle, required this.conceptBody,
    required this.dailyTasks, required this.keyPositions,
    this.tutorialId, required this.resources,
  });
}
...
final List<WeekDetail> weekDetails = [
  WeekDetail(
    week: 1, topic: 'Piece Values & Movement', goal: 'Know every piece\'s power', time: '3 hrs',
    conceptTitle: 'Piece Values',
    conceptBody: 'Each piece has a relative value: Pawn=1, Knight=3, Bishop=3, Rook=5, Queen=9. '
    ...
    keyPositions: [
      _FenPosition('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1', 'Starting position'),
      _FenPosition('8/8/8/4N3/8/8/8/8 w - - 0 1', 'Knight: 8 possible moves from center'),
    ...
    resources: [
      ...
      _ExtLink('Chess.com Piece Movement', 'https://www.chess.com/learn-how-to-play-chess'),
    ],
  ),
  WeekDetail(
    week: 2, topic: 'Basic Checkmates', goal: 'Mate with Q+K, R+K', time: '3 hrs',
    conceptTitle: 'Checkmate Patterns',
    conceptBody: 'Checkmate ends the game. The two most essential patterns are: Queen+King vs King (drive to edge, '
    ...
    keyPositions: [
      _FenPosition('4k3/8/8/8/8/8/8/4K2Q w - - 0 1', 'Q+K vs K: drive king to edge'),
    ...
    resources: [
      ...
      _ExtLink('Checkmate Patterns Video', 'https://www.youtube.com/@GothamChess'),
    ],
  ),
  WeekDetail(
    week: 3, topic: 'Opening Principles', goal: 'Control center, develop pieces', time: '2 hrs',
    conceptTitle: 'The Golden Rules of the Opening',
    conceptBody: '1) Control the center with pawns (e4/d4). 2) Develop minor pieces (knights before bishops). '
    ...
    keyPositions: [
      _FenPosition('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1', '1.e4 — controlling center'),
      _FenPosition('r1bqkbnr/pppppppp/2n5/8/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 2 2', 'Knights developed first'),
    ],
    tutorialId: 'beginner2',
    resources: [
      _ExtLink('Chess.com Opening Principles', 'https://www.chess.com/article/view/chess-openings-the-basics'),
      _ExtLink('GothamChess Opening Guide', 'https://www.youtube.com/@GothamChess'),
    ],
  ),
  WeekDetail(
    week: 4, topic: 'Tactics: Forks & Pins', goal: 'Win material systematically', time: '4 hrs',
    conceptTitle: 'Forks & Pins',
    conceptBody: 'A fork attacks two pieces at once — knights are best at this. A pin immobilizes a piece because '
    ...
    keyPositions: [
      _FenPosition('6k1/5ppp/8/4N3/8/8/5PPP/6K1 w - - 0 1', 'Knight fork potential'),
      _FenPosition('6k1/5ppp/8/8/3b4/5B2/5PPP/6K1 w - - 0 1', 'Pin along diagonal'),
    ],
  ...
  WeekDetail(
    week: 5, topic: 'Tactics: Skewers & Discovered Attacks', goal: 'Spot 2-move combos', time: '4 hrs',
    conceptTitle: 'Skewers & Discoveries',
    conceptBody: 'A skewer is a reversed pin — attack a valuable piece, and when it moves, capture what\'s behind it. '
    ...
    keyPositions: [
      ...
      _FenPosition('6k1/5ppp/8/8/3r4/5B2/5PPP/6K1 w - - 0 1', 'Discovered attack setup'),
    ],
    tutorialId: 'intermediate3',
    resources: [
      _ExtLink('Chess Tempo Tactics', 'https://chesstempo.com'),
      _ExtLink('Tactics Explained Video', 'https://www.youtube.com/@GothamChess'),
    ],
  ),
  WeekDetail(
    week: 6, topic: 'Common Openings', goal: 'Learn Sicilian, Italian, Ruy López', time: '3 hrs',
  ...
  WeekDetail(
    week: 7, topic: 'Pawn Structure', goal: 'Understand weak & passed pawns', time: '3 hrs',
    conceptTitle: 'Pawn Structure Basics',
    conceptBody: 'Pawns can\'t move backward — every pawn move is permanent. Key concepts: isolated pawns (weakness), '
  ...
  WeekDetail(
    week: 8, topic: 'Rook Endgames', goal: 'Lucena & Philidor positions', time: '3 hrs',
    conceptTitle: 'Rook Endgame Essentials',
    conceptBody: '80% of piece endgames involve rooks. The Lucena position (bridge building) wins for the stronger side. '
  ...
  WeekDetail(
    week: 9, topic: 'King & Pawn Endgames', goal: 'Opposition & promotion races', time: '2 hrs',
    conceptTitle: 'Opposition & Key Squares',
    conceptBody: 'Opposition = two kings facing each other with one square gap. The side NOT to move "has the opposition" '
  ...
  WeekDetail(
    week: 10, topic: 'Middlegame Plans', goal: 'Build & execute plans', time: '4 hrs',
    conceptTitle: 'Planning in the Middlegame',
    conceptBody: 'After the opening, ask: What are my advantages? Where should I attack? '
    ...
    keyPositions: [
      _FenPosition('r1bq1rk1/pp2bppp/2n1pn2/3p4/3P4/2N1PN2/PPB2PPP/R1BQ1RK1 w - - 0 9', 'Typical QGD middlegame'),
    ],
  ...
  WeekDetail(
    week: 11, topic: 'Game Analysis', goal: 'Review 10 annotated GM games', time: '5 hrs',
    conceptTitle: 'Learning from the Masters',
    conceptBody: 'Analyzing annotated grandmaster games is the single best way to improve after tactics training. '
  ...
  WeekDetail(
    week: 12, topic: 'Full Game Practice', goal: 'Apply everything in live games', time: '6 hrs',
    conceptTitle: 'Putting It All Together',
    conceptBody: 'This is your graduation week. Play longer time controls (15+10 or 30 min), think about opening principles, '
...
class _WeekScreenState extends State<WeekScreen> {
        ...
        background: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [AppTheme.goldPrimary.withValues(alpha: 0.4), AppTheme.midnight],
          ...
          child: Center(child: Column(
            ...
            children: [
              ...
              Text(_week.topic, style: GoogleFonts.fredoka(
                color: AppTheme.goldPrimary, fontSize: 22, fontWeight: FontWeight.w700,
              )),
              const SizedBox(height: 6),
              Text('🎯 ${_week.goal}  •  ⏱ ${_week.time}', style: GoogleFonts.baloo2(
  ...
  Widget _buildProgressCard() {
    ...
    return Container(
      ...
      child: Column(children: [
        Row(children: [
          Text('📊 Progress', style: GoogleFonts.fredoka(color: AppTheme.textPrimary, fontSize: 16, fontWeight: FontWeight.w700)),
          const Spacer(),
          Text('$pct%', style: GoogleFonts.fredoka(color: AppTheme.goldPrimary, fontSize: 22, fontWeight: FontWeight.w700)),
        ]),
  ...
  Widget _buildConceptCard() {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          const Icon(Icons.lightbulb_rounded, color: AppTheme.accentPurple, size: 20),
          const SizedBox(width: 8),
          Text('Key Concept', style: GoogleFonts.fredoka(color: AppTheme.accentPurple, fontSize: 14, fontWeight: FontWeight.w700)),
        ]),
        const SizedBox(height: 10),
        Text(_week.conceptTitle, style: GoogleFonts.fredoka(color: AppTheme.textPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 8),
        Text(_week.conceptBody, style: GoogleFonts.baloo2(color: AppTheme.textSecondary, fontSize: 14, height: 1.6)),
      ]),
  ...
  Widget _buildDailyTasks() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('📋 Daily Tasks', style: GoogleFonts.fredoka(color: AppTheme.textPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 12),
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _completed[i]
                  ? AppTheme.accentGreen.withValues(alpha: 0.4)
                  : Colors.white.withValues(alpha: 0.05)),
              ),
              child: Row(children: [
                Icon(
                  _completed[i] ? Icons.check_circle_rounded : Icons.radio_button_unchecked,
                  color: _completed[i] ? AppTheme.accentGreen : AppTheme.textMuted, size: 22,
                ),
                const SizedBox(width: 12),
                Expanded(child: Text(
                  'Day ${i + 1}: ${_week.dailyTasks[i]}',
                  style: GoogleFonts.baloo2(
                    color: _completed[i] ? AppTheme.textSecondary : AppTheme.textPrimary,
                    fontSize: 14, fontWeight: FontWeight.w500,
                    decoration: _completed[i] ? TextDecoration.lineThrough : null,
                  ),
                )),
              ]),
            ),
  ...
  Widget _buildKeyPositions() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('♟ Key Positions', style: GoogleFonts.fredoka(color: AppTheme.textPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 12),
        ..._week.keyPositions.map((pos) => Container(
          ...
          child: Row(children: [
            Container(
              ...
              child: const Center(child: Icon(Icons.grid_4x4_rounded, color: AppTheme.skyBlue, size: 22)),
            ),
            const SizedBox(width: 12),
            Expanded(child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(pos.label, style: GoogleFonts.baloo2(color: AppTheme.textPrimary, fontSize: 14, fontWeight: FontWeight.w600)),
                const SizedBox(height: 2),
                Text(pos.fen, style: TextStyle(color: AppTheme.textMuted, fontFamily: 'monospace', fontSize: 10)),
              ],
            )),
          ]),
        )),
      ...
      child: ElevatedButton.icon(
        onPressed: () {
          ...
          context.push('/game/play', extra: GameRouteExtra(
            config: const GameConfig(mode: GameMode.tutorial, playerColor: 'white'),
            tutorial: lesson,
          ));
        },
        icon: const Icon(Icons.play_arrow_rounded, size: 24),
        label: Text('Practice on Board! 🎮', style: GoogleFonts.fredoka(fontSize: 16, fontWeight: FontWeight.w600)),
  ...
  Widget _buildResources() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('🔗 Resources', style: GoogleFonts.fredoka(color: AppTheme.textPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 10),
        ..._week.resources.map((r) => GestureDetector(
          ...
          child: Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(r.title, style: GoogleFonts.baloo2(color: AppTheme.skyBlue, fontSize: 14, fontWeight: FontWeight.w600))),
            ]),
          ),
        )),
      ],
